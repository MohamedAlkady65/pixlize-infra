...
- **AWS CLI** — direct, hands-on experience with 15+ AWS services via CLI (not abstracted by Terraform or CDK); understanding of API parameters, resource dependencies, and ordering
